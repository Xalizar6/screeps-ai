...
module.exports = {
    ...
    run: function (creep) {
        ...
        log.output('Debug', 'Mineral Harvester Run routine took: ' + (Game.cpu.getUsed() - timer) + ' CPU Time', false, true);
...
const runSpawning = function (creep, transitionState) {
    ...
    log.output('Debug', 'Mineral Harvester Spawning routine took: ' + (Game.cpu.getUsed() - timer) + ' CPU Time', false, true);
...
const runMoving = function (creep, transitionState) {
    ...
    log.output('Debug', 'Mineral Harvester Moving routine took: ' + (Game.cpu.getUsed() - timer) + ' CPU Time', false, true);
...
const runHarvesting = function (creep, transitionState) {
    ...
    log.output('Debug', 'Mineral Harvester Harvesting routine took: ' + (Game.cpu.getUsed() - timer) + ' CPU Time', false, true);
