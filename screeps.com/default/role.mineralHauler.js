...
/* global RoomPosition RESOURCE_OXYGEN */
...
module.exports = {
  ...
  run: function (creep) {
    ...
    if (debug) {
      log.output('Debug', 'Mineral Hauler Run routine took: ' + (Game.cpu.getUsed() - timer) + ' CPU Time', false,
        true)
    };
    if (debug) {
...
const runSpawning = function (creep, options) {
  ...
  if (debug) {
    log.output('Debug', 'Mineral Hauler Spawning routine took: ' + (Game.cpu.getUsed() - timer) + ' CPU Time', false,
      true)
  };
  if (debug) {
...
const runMoving = function (creep, options) {
  ...
  if (debug) {
    log.output('Debug', 'Mineral Hauler Moving routine took: ' + (Game.cpu.getUsed() - timer) + ' CPU Time', false,
      true)
  };
  if (debug) {
...
const runGrabResource = function (creep, options) {
  ...
  if (debug) {
    log.output('Debug', 'Mineral Hauler Grab Resource routine took: ' + (Game.cpu.getUsed() - timer) + ' CPU Time',
      false, true)
  };
  if (debug) {
...
const runDepositResource = function (creep, options) {
  ...
  if (debug) {
    log.output('Debug', 'Mineral Hauler Deposit routine took: ' + (Game.cpu.getUsed() - timer) + ' CPU Time', false,
      true)
  };
  if (debug) {
